...
POSTGRES = environ.get("PINGERBOT_POSTGRES", "postgresql://[user]:[password]@[host]:[port]/[database name]")
"""
...
ВАЖНО: Если вы планируете использовать дата базу запущенную через докер, укажите вместо [host] значение db.
"""
